...
const require_factory = require("./factory-jUrF-sdI.cjs");
...
var WorkOSWorker = class extends require_factory.WorkOS {
	...
	createHttpClient(options, userAgent) {
		...
		return new require_factory.FetchHttpClient(this.baseURL, {
			...options.config,
			headers
		});
	}
	/** @override */
	createWebhookClient() {
		return new require_factory.Webhooks(new require_factory.SubtleCryptoProvider());
	}
	getCryptoProvider() {
		return new require_factory.SubtleCryptoProvider();
	}
	/** @override */
	createActionsClient() {
		return new require_factory.Actions(new require_factory.SubtleCryptoProvider());
	}
	/** @override */
	emitWarning(warning) {
...
exports.OauthException = require_factory.OauthException;
exports.OrganizationDomainState = require_factory.OrganizationDomainState;
exports.OrganizationDomainVerificationStrategy = require_factory.OrganizationDomainVerificationStrategy;
